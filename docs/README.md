...
| `remote_src_certs`           | `false`                            | TLS: controls whether certificates are copied from the local machine or from the remote host. When set to yes, the certificates are sourced from the remote host.                                                                                                                                         |
...
| `redpanda_listen_address`    | `private_ip`                       | The address on which Redpanda services (RPC, Kafka API, Admin) will listen for connections                                                                                                                                                                                                                |
| `redpanda_connection_address`| `private_ip`                       | The address that will be advertised to other nodes for connections                                                                                                                                                                                                                                        |
